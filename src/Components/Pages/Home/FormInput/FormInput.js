  ...
  const submitTotalTags = (e) => {
    ...
    for (let i = 0; i < drinkList.length; i++) {
      ...
      if (userInputLiquors == "") {
        ...
        console.log(
          userInputLiquors + " is found! in " + drinkList[i].name.toString()
        );
      }
      if (userInputLiqueurs == "") {
        ...
        console.log(
          userInputLiqueurs + " is found! in " + drinkList[i].name.toString()
        );
      }
      if (userInputMixers == "") {
        ...
        console.log(
          userInputMixers + " is found! in " + drinkList[i].name.toString()
        );
      }
    }
  };
        ...
        <div className={classes.formInputs}>
          <div className={classes.liquorsDiv}>
            ...
            <input
              ...
              id="liquorInput"
            />
            <button onClick={addLiquor} type="submit">
              Add Liquor
            </button>
          </div>
          <div className={classes.liqueursDiv}>
            ...
            <input
              ...
              id="liqueurInput"
            />
            <button type="submit" onClick={addLiqueur}>
              Add Liqueur
            </button>
          </div>
          <div className={classes.mixersDiv}>
            ...
            <input
              ...
              id="mixerInput"
            />
            <button type="submit" onClick={addMixer}>
              Add mixers
            </button>
          </div>
        </div>
